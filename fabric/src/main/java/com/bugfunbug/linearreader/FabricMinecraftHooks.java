...
final class FabricMinecraftHooks implements MinecraftHooks {

    static final FabricMinecraftHooks INSTANCE = new FabricMinecraftHooks();

    private FabricMinecraftHooks() {}
