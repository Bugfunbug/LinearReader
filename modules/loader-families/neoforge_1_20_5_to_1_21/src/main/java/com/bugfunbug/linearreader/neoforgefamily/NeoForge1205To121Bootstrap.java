...
public final class NeoForge1205To121Bootstrap implements LoaderBootstrap {

    private final MinecraftFamily minecraftFamily;
    private final LinearRuntime runtime;

    public NeoForge1205To121Bootstrap(MinecraftFamily minecraftFamily, IEventBus modEventBus, ModContainer modContainer) {
