...
public abstract class RegionFileStorageMixin {
     ...
     *         26.3 added a "create" parameter to vanilla's getRegionFile(ChunkPos, boolean);
     *         LinearReader always resolves/creates its own storage regardless of this flag.
     */
    @Overwrite
    private synchronized RegionFile getRegionFile(ChunkPos pos, boolean create) throws IOException {
        ensureLinearCacheInitialized();
        long key = ChunkPos.pack(pos.getRegionX(), pos.getRegionZ());
