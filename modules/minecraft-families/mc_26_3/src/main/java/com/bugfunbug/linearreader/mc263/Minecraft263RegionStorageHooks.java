...
public final class Minecraft263RegionStorageHooks implements RegionStorageHooks {

    public static final Minecraft263RegionStorageHooks INSTANCE =
            new Minecraft263RegionStorageHooks();

    private Minecraft263RegionStorageHooks() {}
